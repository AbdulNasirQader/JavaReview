...
public class Methods {
    ...
    //create a method that finds returns the largest number between given 2 integer values
    ...
    // create a methods that return an average value of 2 decimal numbers
    double findAverage(double num1, double num2){
        return (num1+num2)/2;
    }

    //return reverse String from a given String
